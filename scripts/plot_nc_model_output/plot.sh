...
plot_models='RAVEN-GR4J VIC VIC-GRU' #'LBRM VIC VIC-GRU GEM-Hydro SWAT RAVEN-GR4J' # can be [LBRM, HYPE, GEM-Hydro, WRF-Hydro, MESH-SVS, MESH-CLASS, VIC, VIC-GRU, WATFLOOD]
