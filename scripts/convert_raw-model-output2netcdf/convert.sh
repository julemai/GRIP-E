...
convert_models='LBRM VIC VIC-GRU GEM-Hydro SWAT WATFLOOD'  # can be [LBRM, HYPE, GEM-Hydro, WRF-Hydro, MESH, VIC, VIC-GRU, WATFLOOD]
convert_obj='1'      # can be 1, 2, and/or 3
