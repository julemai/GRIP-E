...
plot_models='ML-EA-LSTM ML-LSTM ML-XGBoost LBRM-MG LBRM-ML-LSTM'               # [    Lake Erie:   LBRM HMETS-Raven-lp GR4J-Raven-lp GR4J-Raven-sd HYPE GEM-Hydro WRF-Hydro MESH-SVS MESH-CLASS VIC VIC-GRU
