...
model_order = ['ml-linreg', 'ml-convlstm', 'ml-convlstm-dem', 'ml-convlstm-lc', 'ml-convlstm-lc-dem', 'ml-lstm', 'ml-ea-lstm', 'ml-xgboost', 'lbrm', 'gr4j-raven-lp', 'gr4j-raven-sd', 'hymod2-ds', 'hmets-raven-lp', 'swat-epa', 'swat-guelph', 'raven-blended', 'mhm-waterloo', 'mhm-ufz', 'hype', 'vic', 'vic-gru', 'gem-hydro', 'mesh-svs', 'mesh-class', 'watflood', 'wrf-hydro']
...
models_group = [['ml-linreg', 'ml-convlstm', 'ml-convlstm-dem', 'ml-convlstm-lc', 'ml-convlstm-lc-dem', 'ml-lstm', 'ml-ea-lstm', 'ml-xgboost'],
                ['lbrm', 'gr4j-raven-lp', 'gr4j-raven-sd', 'hymod2-ds', 'hmets-raven-lp', 'swat-epa', 'swat-guelph', 'raven-blended', 'mhm-waterloo']]
